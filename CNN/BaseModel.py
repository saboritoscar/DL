...
plt.savefig('./model1/sgd_cnn_accuracy'+'_'+str(Num_epochs)+'_'+str(Batch_size)+'.pdf')
plt.close()
#Loss plot
...
plt.xlabel('epoch')
plt.legend(['train','val'], loc='upper left')
plt.savefig('./model1/sgd_cnn_loss'+'_'+str(Num_epochs)+'_'+str(Batch_size)+'.pdf')
...
pl.colorbar()
pl.savefig('./model1/sgd_cnn_confmat'+'_'+str(Num_epochs)+'_'+str(Batch_size)+'.pdf')
...
# nn_json = nn.to_json()
# with open('./models/adam_cnn_confmat'+'_'+str(Num_epochs)+'_'+str(Batch_size)+'.json', 'w') as json_file:
#         json_file.write(nn_json)
# weights_file = "weights-MNIST_"+str(score[1])+".hdf5"
# nn.save_weights(weights_file,overwrite=True)
#
# #Loading model and weights
# json_file = open('./models/adam_cnn_confmat'+'_'+str(Num_epochs)+'_'+str(Batch_size)+'.json','r')
