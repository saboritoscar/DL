...
plt.savefig('./model2/4L-dpout20-adam_cnn_accuracy_batch'+'_'+str(Num_epochs)+'_'+str(Batch_size)+'_'+str(dense_size)+'.pdf')
plt.close()
#Loss plot
...
plt.xlabel('epoch')
plt.legend(['train','val'], loc='upper left')
plt.savefig('./model2/4L-dpout20-adam_cnn_loss_batch'+'_'+str(Num_epochs)+'_'+str(Batch_size)+'_'+str(dense_size)+'.pdf')
...
pl.colorbar()
pl.savefig('./model2/4L-dpout20-adam_cnn_confmat'+'_'+str(Num_epochs)+'_'+str(Batch_size)+'_'+str(dense_size)+'.pdf')
...
nn_json = nn.to_json()
with open('./models/4L-dpout21-adam_cnn_confmat'+'_'+str(Num_epochs)+'_'+str(Batch_size)+'_'+str(dense_size)+'.json', 'w') as json_file:
