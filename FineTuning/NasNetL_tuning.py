...
model = applications.nasnet.NASNetLarge( weights=None, include_top=False, input_shape = (img_width, img_height, 3))
...
tensorboard = TensorBoard(log_dir="logs/NasNet_noWeights"+str(flayers)+optimizer+str(lrate))
