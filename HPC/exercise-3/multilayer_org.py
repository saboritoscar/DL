  ...
  for e in range(epochs):
    ...
    for i in range(iterations):
      if 1:   
        ...
        batch_ini = batch_size*(iterations-i) - batch_size
        batch_end = batch_size*(iterations-i) 
...
plt.title('MNIST multilayer train')
...
plt.xlabel('epochs')
plt.ylabel('accuracy')
plt.savefig('50_epoch_standard_accuracies.png')
