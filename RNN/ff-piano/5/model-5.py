...
def get_notes():
    ...
    if load:
        for file in glob.glob("midi_data/*.mid"):
            ...
            print(notes)
        with open('/gpfs/projects/bsc99/bsc99526/OTHERS/Classical-Piano-Composer-master/data/tnotes', 'wb') as filepath:
            pickle.dump(notes, filepath)
    else:
        with open('/gpfs/projects/bsc99/bsc99526/OTHERS/Classical-Piano-Composer-master/data/tnotes', 'rb') as filepath:
